...
pub fn snap_1s_schema() -> &'static Schema {
    SNAP_1S_SCHEMA.get_or_init(|| {
        ...
        fields.extend([
            ...
            Field::new("bid_depth_l5", DataType::Float64, false),
            Field::new("bid_depth_l10", DataType::Float64, false),
            Field::new("ask_depth_l5", DataType::Float64, false),
            Field::new("ask_depth_l10", DataType::Float64, false),
            Field::new("ofi_l1", DataType::Float64, false),
            Field::new("churn_bid", DataType::Float64, false),
            Field::new("churn_ask", DataType::Float64, false),
            Field::new("intra_sigma", DataType::Float32, false),
